...
const CreditCard = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-transparent bg-gradient-to-bl min-h-screen w-auto from-blue-400 via-blue-200 to-blue-400 backdrop-blur-sm">
      <div className="flex flex-col justify-center items-center md:gap-20 sm:gap-16 bg-white bg-opacity-40 gap-7 shadow-sm rounded-3xl px-6 md:px-8 lg:px-20 sm:py-20 py-8">
        <div className="flex md:flex-row flex-col items-center justify-center md:gap-20 gap-12">
          <div className="flex flex-col w-full">
            ...
            <div className="grid grid-cols-4 justify-between bg-[#210D09ED] text-white h-48 w-full max-w-xs rounded-lg px-3.5 py-1.5 shadow-xl transition duration-400 hover:scale-110 sample3">
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col justify-between bg-white h-48 w-full max-w-xs rounded-lg pt-5 pb-2 italic text-[4px] transition shadow-xl duration-400 hover:scale-110 sample3">
              <div>
                ...
                <div className="flex justify-between">
                  <div className="flex flex-col w-48 mt-2">
                    ...
                    <div className="text-left ml-1 mt-2"></div>
                  </div>
...
/* const BnakName = () => {
  return (
    ...
    >
      <path
        d="M2.04175 4.08337H12.6176C14.1284 4.08337 15.5133 4.39813 16.7724 5.02764C18.0566 5.65716 19.0638 6.5133 19.794 7.59606C20.5243 8.67882 20.8894 9.86231 20.8894 11.1465C20.8894 12.5063 20.5495 13.6898 19.8696 14.697C19.2149 15.679 18.3462 16.4344 17.2634 16.9632V17.2654C18.6735 17.769 19.794 18.5748 20.625 19.6827C21.456 20.7655 21.8714 22.0749 21.8714 23.6109C21.8714 25.0965 21.4685 26.4185 20.6628 27.5768C19.8822 28.71 18.812 29.5913 17.4522 30.2208C16.1177 30.8251 14.632 31.1273 12.9953 31.1273H2.04175V4.08337ZM12.2399 15.1125C13.3478 15.1125 14.2291 14.8103 14.8838 14.206C15.5637 13.5764 15.9036 12.7958 15.9036 11.8642C15.9036 10.9577 15.5763 10.2022 14.9216 9.59791C14.2921 8.9684 13.4485 8.65364 12.391 8.65364H7.14081V15.1125H12.2399ZM12.8064 26.4815C14.0403 26.4815 14.9971 26.1667 15.677 25.5372C16.3821 24.8825 16.7346 24.039 16.7346 23.0066C16.7346 21.9742 16.3821 21.1306 15.677 20.4759C14.972 19.8212 13.9647 19.4939 12.6554 19.4939H7.14081V26.4815H12.8064Z"
        fill="#FFFCFC"
      />
      <path
